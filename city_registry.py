...
CITIES: dict[str, CityConfig] = {
    ...
    "bucharest": CityConfig(
        ...
        reservation_platforms=["bookingham", "thefork", "opentable"],
        michelin_slug=None,
        michelin_indexed=False,
        timeout_path=None,
        cnt_paths=[],
        curated_list_file="bucharest.json",
        notes="Bookingham.ro is primary. TheFork has limited coverage (international hotels). OpenTable as fallback for international chain restaurants.",
    ),
