...
CURATED: dict[str, list[dict]] = {
    ...
    "bucharest": [
        ...
        },
        {
            ...
            "notes": "Sophisticated fine dining, city centre. Pricier option. ⭐ Yonatan's saved place (4.7, lei 200+).",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
            "name": "Vacamuuu",
            "cuisine": "Romanian / Grill",
            "notes": "⭐ Yonatan's saved place (4.7, 5,224 reviews, lei 200+). Highly rated, popular local spot.",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
            "name": "Osho",
            "cuisine": "Steak",
            "notes": "⭐ Yonatan's saved place (4.5, 3,656 reviews, lei 200+). Well-reviewed steakhouse.",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
            "name": "JW Steakhouse",
            "cuisine": "Steak",
            "notes": "⭐ Yonatan's saved place (4.5, lei 200+). Classic steakhouse.",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
            ...
            "cuisine": "Restaurant",
            "notes": "⭐ Yonatan's saved place (4.8, 17,553 reviews, lei 200+). Exceptional rating, very popular.",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
            "name": "Kupaj Gourmet",
            "cuisine": "Gourmet",
            "notes": "⭐ Yonatan's saved place (4.8, lei 200+). High-end, excellent reviews.",
            "booking_platform": "bookingham",
            "kai_pick": True,
        },
        {
